...
public:
    ...
    void identificar() override {
        cout << "Meu nome e " << nomeCompleto
             << ", sou o coordenador do departamento de " << departamento << " no Inatel." << endl;
    }
};
...
public:
    ...
    void identificar() override {
        cout << "Meu nome e " << nomeCompleto
             << ", e realizo pesquisas no laboratorio " << laboratorio << " do Inatel." << endl;
    }
};

int main() {
    Coordenador c;
    c.nomeCompleto = "Renzo";
    c.departamento = "Engenharia de Software";

    Pesquisador p;
    p.nomeCompleto = "Samuel Baraldi";
